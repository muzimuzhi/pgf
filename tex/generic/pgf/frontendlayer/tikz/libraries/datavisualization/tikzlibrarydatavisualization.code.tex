...
\def\tikz@lib@dv@add@#1#2{%
  \ifcsname tikz@lib@dv@#1\endcsname
    \expandafter\pgfutil@addto@macro\csname tikz@lib@dv@#1\endcsname{,#2}%
  \else
    \expandafter\def\csname tikz@lib@dv@#1\endcsname{#2}%
  \fi
}%
\tikz@lib@dv@add@{common}{}
\tikz@lib@dv@add@{major}{}
\tikz@lib@dv@add@{minor}{}
\tikz@lib@dv@add@{subminor}{}
...
\def\tikz@lib@dv@default@action#1#2#3{%
  ...
  {%
    ...
    \else%
      ...
      \xdef\tikz@marshal{%
        \tikz@lib@dv@major,\tikz@lib@dv@minor,\tikz@lib@dv@subminor}%
    \fi
  }%
  ...
  \else
    {%
      ...
      \scope[/tikz/data visualization/.cd,every ticks/.try,every #1 ticks/.try,#3]%
        % Setup options
        \expandafter\tikzdatavisualizationset\expandafter{\tikz@lib@dv@settings}%
        \expandafter\tikzdatavisualizationset\expandafter{\tikz@lib@dv@common}
        \expandafter\expandafter\expandafter\tikzdatavisualizationset\expandafter\expandafter\expandafter{\csname tikz@lib@dv@#1\endcsname}
