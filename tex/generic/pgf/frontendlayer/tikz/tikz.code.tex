...
\def\tikz@@coordinate@at[#1](#2)a{%
  \pgfutil@ifnextchar t{\tikz@fig ode[shape=coordinate,#1](#2)\pgfextra{\def\tikz@node@content{}}a}%
    ...
    {\pgfutil@ifnextchar[{\tikz@fig@scan@options}%
      {\pgfutil@ifnextchar:{\tikz@fig@scan@animation}%
        {\pgfutil@ifnextchar\bgroup{\tikz@fig@main}%
          {\pgfutil@ifnextchar\pgfextra{\tikz@fig@scan@extra}
...
\long\def\tikz@fig@scan@options[#1]{\iftikz@node@is@pic\tikz@enable@pic@quotes\else\tikz@enable@node@quotes\fi\tikzset{#1}\tikz@fig@quick@end}%
\def\tikz@fig@quick@end{%
  \ifx\tikz@node@content\relax
    \expandafter\tikz@@scan@fig
  \else
    \expandafter\tikz@expand@node@contents
  \fi
}
...
\def\tikz@fig@scan@extra\pgfextra{\pgfutil@ifnextchar\bgroup\tikz@@fig@scan@extra\tikz@@@fig@scan@extra}
\def\tikz@@fig@scan@extra#1{#1\tikz@@scan@fig}
\def\tikz@@@fig@scan@extra#1\endpgfextra{#1\tikz@@scan@fig}
\def\tikz@fig@main{%
  \iftikz@node@is@pic%
