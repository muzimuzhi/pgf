...
%
% #1 - the name of the operator, usually one or two characters
% #2 - the name of the function to be accosicated 
% #3 - arity
% #4 - one of "prefix", "infix", or "postfix"
% #5 - precedence
%
...
\def\pgfmathdeclareoperator#1#2#3#4#5{%
  % \string could only detokenize a single token
  \edef\pgfmath@temp{\detokenize{#1}}%
  \ifx\pgfmath@operatorlist\pgfutil@empty
    \edef\pgfmath@operatorlist{{\pgfmath@temp}}%
  \else
    \edef\pgfmath@operatorlist{\pgfmath@operatorlist,{\pgfmath@temp}}%
  \fi
  \pgfmath@namedef{pgfmath@operator@\pgfmath@temp}{#1}%
  \pgfmath@namedef{pgfmath@operation@\pgfmath@temp @name}{#2}%
  \pgfmath@namedef{pgfmath@operation@\pgfmath@temp @arity}{#3}%
  \pgfmath@namedef{pgfmath@operation@\pgfmath@temp @#4}{#1}%
  \pgfmath@namedef{pgfmath@operation@\pgfmath@temp @precedence}{#5}%
}
