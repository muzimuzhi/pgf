...
\pgfkeys{/pgf/.cd,
    ...
    shape aspect/.style={/pgf/aspect=#1}%
}%
...
\pgfkeys{/pgf/.cd,
    ...
    star point height/.code={%
        \def\pgf@lib@shapes@starpointheight{#1}%
        \pgf@lib@shapes@starouterradiususesratiofalse%
    },
    star point ratio/.code={%
        \def\pgf@lib@shapes@starpointratio{#1}%
        \pgf@lib@shapes@starouterradiususesratiotrue%
    },%
...
\pgfdeclareshape{star}{%
    ...
    \savedmacro\calculateradii{%
        ...
        \ifpgf@lib@shapes@starouterradiususesratio%
            \pgfmathparse{\pgf@lib@shapes@starpointratio}%
            \expandafter\pgf@x\pgfmathresult\pgf@x%
        \else%
            \pgfmathaddtolength\pgf@x{\pgf@lib@shapes@starpointheight}%
        \fi%
        \pgf@xc\pgf@x%
        %
       ...
       \ifdim\pgf@x>\pgf@xc%
        ...
        %
        \ifpgf@lib@shapes@starouterradiususesratio%
            \pgfmathreciprocal{\pgf@lib@shapes@starpointratio}%
            ...
            \else%
                ...
                %
                \pgf@xa\pgf@x\relax%
                \pgfmathaddtolength\pgf@xa{-\pgf@lib@shapes@starpointheight}%
                \edef\innerradius{\the\pgf@xa}%
            \fi%
        \fi%
        \edef\outerradius{\the\pgf@x}%
